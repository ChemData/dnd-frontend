...
const NUMBER_MULTIPLIER = {1: 1, 2:1.5, 3:2, 4:2, 5:2, 6:2, 7:2.5, 8:2.5, 9:2.5, 10:2.5, 11:3, 12:3, 13:3, 14:3, 15:4}
const DIFFICULTIES = {
...
class Group{
    ...
    addMob(newMobs?: MobType| MobType[]){
        ...
        this.xpTotal = this.mobs.reduce((total, mob) => total + mobData.statBlock(mob.statBlockId).xp, 0) * (NUMBER_MULTIPLIER[this.mobs.length] || 4)
