  ...
  <div>
    ...
    <div class="player_section">
      <PersonalCampingEvents
        v-for="index in n_players"
        :key="index"
        ref="player"
        :party_points="partyPoints"
      ></PersonalCampingEvents>
    </div>
    <div>
      <button @click="addPlayer">Add Player</button> &nbsp <button @click="removePlayer">Remove Player</button> &nbsp
      <button @click="clear">Clear</button>
    </div>
    <div>
      Credit for this rule set goes to Phixium:
      <a href="https://www.gmbinder.com/share/-MmKzM9-KS2KZLQBcGsZ" target="_blank">PDF</a>
    </div>
  </div>
</template>
