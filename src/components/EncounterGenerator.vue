  ...
  methods: {
    ...
    async generateBattle() {
      ...
      let payload = {
        ...
        'minimum_cr': this.minimum_cr, 'roll_hp': this.roll_hp, 'wildness': wildness_val}
      try {
  ...
  <div id="inputs">
    ...
    <div id="enemies">
      ...
      <div>
        ...
        <select
          id="primary_enemy_select"
          v-model="primary_enemy"
        >
          <option value="">
            None
          </option>
          <option
            v-for="enemy in enemy_options"
            :key="enemy.value"
            :value="enemy.value"
          >
            {{ enemy.name }}
    ...
    <div id="surroundings">
      <div>
        ...
        >
          ...
          <option
            v-for="terrain in terrain_options"
            :key="terrain.value"
            :value="terrain.value"
          >
            {{ terrain.name }}
      ...
      <div>
        ...
        <select v-model="wildness">
          <option
            v-for="wildness_val in wildness_options"
            :key="wildness_val.value"
            :value="wildness_val.value"
          >
            {{ wildness_val.name }}
          </option>
        </select>
