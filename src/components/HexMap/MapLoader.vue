...
<template>
  <div>
    <button type="button" class="button is-small" @click="showModal = true">New</button>
    <button type="button" class="button is-small" @click="saveMap">Save</button>
    <button type="button" class="button is-small" @click="loadMap">Load</button>
    <button type="button" class="button is-small" @click="deleteMap">Delete</button>
    <select v-model="selected_map_name" class="select is-small">
      <option disabled value="">Select a Map</option>
      <option v-for="map_name in map_list" :value="map_name">
        {{ map_name }}
      </option>
    </select>
  </div>
  <div v-if="showModal" class="modal">
    <div class="modal-content">
      ...
      <button @click="newMap">Make</button>
