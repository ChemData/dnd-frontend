...
<template>
  <div>
    ...
    >
      <option disabled value="" class="dropdown">Terrain</option>
      <option v-for="(info, key) in terrain_info" :key="key" :value="key" class="dropdown">
        {{ info.name }}
      </option>
    </select>
    <select
    ...
    >
      <option disabled value="" class="dropdown">River</option>
      <option v-for="(info, key) in river_info" :key="key" :value="key" class="dropdown">
        {{ info.display }}
      </option>
      <option value="none" class="dropdown">Delete</option>
    </select>
    <select
      v-model="roads"
    ...
    >
      <option disabled value="" class="dropdown">Road</option>
      <option v-for="(info, key) in road_info" :key="key" :value="key" class="dropdown">
        {{ info.display }}
      </option>
      <option value="none" class="dropdown">Delete</option>
    </select>
    ...
    >
      <option disabled value="" class="dropdown">Settlement</option>
      <option v-for="(info, key) in settlement_info" :key="key" :value="key" class="dropdown">
        {{ info.display }}
      </option>
    </select>
    <select
    ...
    >
      <option disabled value="" class="dropdown">Wildness</option>
      <option v-for="(info, key) in wildness_info" :key="key" :value="key" class="dropdown">
        {{ info.name }}
      </option>
    ...
    >
      <option disabled value="" class="dropdown">Visibility</option>
      <option value="false" class="dropdown">DM Only</option>
      <option value="true" class="dropdown">Players & DM</option>
    </select>
  </div>
</template>
