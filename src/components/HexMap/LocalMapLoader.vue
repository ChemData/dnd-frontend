...
<template>
  <div>
    ...
    <button type="button" class="button is-small" @click="localSaveMap">Save</button>
    <label class="file-input-label">
      <input type="file" accept=".map" style="display: none" @change="localLoadMap" />
      <span class="button is-small"> Load Map </span>
    </label>
  </div>
